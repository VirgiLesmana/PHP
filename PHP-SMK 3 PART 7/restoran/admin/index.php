    ...
    <div class="container">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="float-right mt-4 mr-4">Use : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?></a></div>
                <div class="float-right mt-4 mr-3">LEVEL : <?php echo $_SESSION['level'] ?></div>
